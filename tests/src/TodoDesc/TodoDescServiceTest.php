...
use CRM\TodoDesc\{ TodoDescDto, TodoDescModel, ITodoDescService, TodoDescService };

class TodoDescServiceTest extends TestCase
{
    private MockObject $repository;
    private array $input;
    private TodoDescDto $dto;
    private TodoDescModel $model;
    private ITodoDescService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new TodoDescService($this->repository);
    }
